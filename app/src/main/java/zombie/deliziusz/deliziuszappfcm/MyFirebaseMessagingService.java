...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void showNotification(Map<String, String> data){
        ...
        String NOTIFICAION_CHANNEL_ID =getString(R.string.default_notification_channel_id);
    ...
    private void showNotification(String title, String body) {
        ...
        //
        String NOTIFICATION_CHANEL_ID = getString(R.string.default_notification_channel_id);
